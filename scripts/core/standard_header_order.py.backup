...
# 동적으로 생성 - @core/header_registry.py에서 창고/현장 순서 가져오기
...
# 동적으로 창고/현장 컬럼 가져오기 (SSOT from header_registry)
_STAGE2_WAREHOUSE_COLS = HVDC_HEADER_REGISTRY.get_warehouse_columns()
_STAGE2_SITE_COLS = HVDC_HEADER_REGISTRY.get_site_columns()

_STAGE2_DERIVED_COLS = [
    "Source_Sheet",
    "Status_WAREHOUSE",
    "Status_SITE",
    "Status_Current",
