...
class HeaderNormalizer:
    ...
    def normalize(self, header: str, expand_abbreviations: bool = True) -> str:
        ...
        # Step 3: Remove all special characters and separators while keeping
        # any letter or number from any language intact
        normalized = self._strip_separators(normalized)

        # Step 4: Remove remaining non-letter/number characters using
        # Unicode-aware filtering instead of ASCII-only regex
