...
### 전체 파이프라인 하드코딩 제거
- ✅ Stage 1: WAREHOUSE_ORDER, SITE_ORDER 제거
- ✅ Stage 2: column_definitions.py Core 사용
- ✅ Stage 3: column_definitions.py, report_generator.py Core 사용
- ✅ Stage 4: 헤더 정규화 적용

### CORE 의존성 공지 추가
- 모든 스테이지 주요 파일에 정책 문서 추가
- 하드코딩 금지 명시
- Core 문서 링크 제공

### 창고 정의 정리
- "HAULER" = "Hauler Indoor" (동일한 창고)
- 총 9개 창고, 4개 사이트로 정리
- 모든 별칭 Registry에 등록

### 이전 업데이트 (v4.0.12 - 2025-10-22)
