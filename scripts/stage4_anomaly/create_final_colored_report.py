...
def create_final_colored_report():
    ...
    anomaly_report_path = Path("data/anomaly/HVDC_anomaly_report_fixed.xlsx")
    ...
    for col in range(1, ws.max_column + 1):
        ...
        if header_value and (
            str(header_value) == "Case No." or "CASE_NO" in str(header_value).upper()
        ):
            case_col = col
    ...
    print("\n[Step 6] 이상치 색상 적용 중...")
    applied_count = 0
    anomaly_counts = {"시간 역전": 0, "ml_high": 0, "ml_medium": 0, "데이터 품질": 0, "기타": 0}
